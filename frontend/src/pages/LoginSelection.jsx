      ...
      <main className="mx-auto w-full max-w-7xl px-6 pb-20 pt-32 lg:px-8">
        ...
        <div className="mb-20 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          <article className="rounded-xl border border-[#dbe2f4] bg-white/70 p-8 text-center backdrop-blur-sm transition-all duration-300 hover:bg-white">
            ...
            <Link to="/admin-login" className="block w-full rounded-xl bg-gradient-to-br from-[#4a40e0] to-[#9795ff] py-3 font-semibold text-white shadow-lg shadow-[#4a40e0]/20 transition-opacity hover:opacity-90">
              Enter portal
            </Link>
          </article>
          ...
          <article className="rounded-xl border border-[#dbe2f4] bg-white/70 p-8 text-center backdrop-blur-sm transition-all duration-300 hover:bg-white">
            ...
            <Link to="/god-login" className="block w-full rounded-xl bg-[#040e1f] py-3 font-semibold text-white transition-opacity hover:opacity-90">
              Enter portal
            </Link>
          </article>
        </div>
        ...
        <section className="relative mx-auto max-w-3xl overflow-hidden rounded-2xl bg-[#e5e9f7] p-10 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/forgot-password" className="flex items-center gap-2 rounded-xl border border-[#a2adc4]/30 bg-white px-6 py-3 font-semibold text-[#4a40e0] transition-colors hover:bg-[#f4f6ff]">
