      ...
      <section className="grid grid-cols-1 gap-5 xl:grid-cols-12">
        <div className="space-y-4 xl:col-span-7">
          <div className="flex items-center justify-between">
            ...
            <Link href="/student/exams" className="group inline-flex items-center gap-2 text-sm font-bold text-[#4a40e0] hover:underline">
              Open Schedule
        ...
        <div className="space-y-4 xl:col-span-5">
          <div className="flex items-center justify-between">
            ...
            <Link href="/student/results" className="text-sm font-bold text-[#4a40e0] hover:underline">
              View all
            </Link>
          </div>
