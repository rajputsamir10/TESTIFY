      ...
      <div className="lg:grid lg:min-h-screen lg:grid-cols-[15.5rem_1fr]">
        ...
        >
          <div className="mb-9 flex items-center gap-3 px-5">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br from-[#4a40e0] to-[#702ae1] text-[#f4f1ff] shadow-[0_10px_20px_-10px_rgba(74,64,224,0.6)]">
              <BarChart2 className="h-4.5 w-4.5" />
            </div>
            <div>
              <p className="font-heading text-2xl font-extrabold leading-none tracking-tight text-[#4a40e0]">Testify</p>
              <p className="mt-1 text-[9px] font-bold uppercase tracking-[0.2em] text-[#515c70]">Digital Curator</p>
            </div>
          </div>
          ...
          <div className="space-y-1 px-4 pb-3 pt-6">
            <NavLink
              to="/student/profile"
              onClick={() => setOpen(false)}
              className="flex items-center gap-3 rounded-2xl px-3.5 py-2.5 text-[13px] font-semibold text-[#6c778c] transition-all hover:bg-white/40 hover:text-[#4a40e0]"
            >
        ...
        <div className="relative flex min-h-screen flex-col overflow-x-hidden">
          ...
          <header className="sticky top-0 z-30 flex h-16 items-center gap-3 border-b border-white/20 bg-white/40 px-4 backdrop-blur-2xl sm:px-5 lg:px-7">
            ...
            <div className="hidden max-w-md flex-1 items-center rounded-2xl border border-slate-200/60 bg-white/80 px-4 py-2.5 shadow-sm transition-all focus-within:border-[#4a40e0]/40 focus-within:ring-4 focus-within:ring-[#4a40e0]/5 sm:flex">
              ...
              <input
                type="text"
                placeholder="Search exams, results, or modules..."
            ...
            <div className="ml-auto flex items-center gap-2 sm:gap-3 lg:gap-4">
              ...
              <div className="flex items-center gap-3">
                <div className="hidden text-right sm:block">
                  <p className="font-heading text-[15px] font-bold leading-tight text-[#242f41]">{user?.full_name || 'Student User'}</p>
                  <p className="text-[11px] font-bold capitalize tracking-tight text-[#4a40e0]">{user?.role || 'student'} workspace</p>
                </div>
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl border-2 border-white bg-gradient-to-br from-[#6e8cff] to-[#4a40e0] text-sm font-extrabold text-white shadow-md">
                  {initials || 'SU'}
                </div>
              </div>
            </div>
